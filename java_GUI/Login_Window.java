...
public class Login_Window extends JFrame
{
	...
	// Title of Login_Window.
	public static final String TITLE = "Login Window";
 	...
 	public Login_Window()
	{
		...
		confirm_button.addActionListener(new Listener_For_Login_Button(enter_field_username, enter_field_password));
